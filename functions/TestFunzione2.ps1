...
param(
    [string]$FunctionUrl = "https://ogkqcppxolscwzhkcqdr.supabase.co/functions/v1/CalcolaDuplicatiProgressivo",    # fallback su variabile d'ambiente
    [string]$ApiKey = "95d28d0267326d8b1b47a49fcd62bb27aa318ec725c5b76fb728a8bbd06e2104"       # opzionale: service role o anon key
)
